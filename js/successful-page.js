...
//////////////////
// Check for allocation ID on page load
function checkAllocationId() {
...
// Run check if on allocation-created page
if (window.location.pathname.includes('allocation-created.html')) {
    checkAllocationId();
}
